...
%climate=create20thCenturyClimate_Spinup(20);
...
MD_year=createDailyInterpMDdataFromAVG;
...
AWC=AWC*AWC_mod_mc;             % soil moisture modifying factor for
                                % volcanic effects
...
LLsat_uncert=readmatrix('../Data/SatDepths_uncert.csv');
dates_sat_uncert=datetime(LLsat_uncert(:,3),LLsat_uncert(:,2),LLsat_uncert(:,1));
...
% %calculate rmse for satellite observations
[~,a1,b1]=intersect(dates_clim,dates_sat);
lm_sat=fitlm(LLsat(b1,4),daily_LDv(a1));
